...
public class StepsDefinition {
	...
	public void the_client_issues_POST_hello() throws Throwable {
		...
		response = RestAssured.get("http://dummy.restapiexample.com/api/v1/employees");// dummy API call to verify 200
																						// OK
	...
	public void displayCheapestPriceForEachType() throws Exception {
		// Application.getMinPriceByCarCode(response.asString()); //Will be called when
		// getting the actual response. Passing the response JSON directly in this case
